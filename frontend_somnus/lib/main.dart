...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      int TestCase =
          8; //7 -- lua //6 -- go //---5 ruby  //---4 ios //--3 call back;  //--2  call python //--1 android api //--0 develop
      ...
      if (TestCase == 0) {
        ...
        StarParaPkgClass ParaPkg1 =
            await StarSrvGroup.newParaPkg({"a": 1, "b": 2, "c": 3});
        print(await ParaPkg1[0]);
        print(await ParaPkg1.toTuple());

        StarParaPkgClass ParaPkg2 = await StarSrvGroup.newParaPkg([
          345.67,
          {"a": 1, "b": 2, "c": 3}
        ]);
        ...
        dynamic Android_Context = await Service.importRawContext(
            "java", "android.content.Context", false, "");
        ...
        dynamic Android_PackageManager = await Service.importRawContext(
            "java", "android.content.pm.PackageManager", false, "");
        ...
        await CallBackObj.regScriptProcP("PrintHello",
            (StarObjectClass cleObject, List paras) async {
          print("$paras");
          return [
            "return from go",
            {"pa": 1, "pb": 2, "pc": 3},
...
*/
        ...
        StarObjectClass ruby =
            await Service.importRawContext("ruby", "", false, "");
        ...
        await SrvGroup.doFile(
            "ruby", resPath + "/flutter_assets/starfiles/" + "testcallback.rb");
        ...
        StarObjectClass lua =
            await Service.importRawContext("lua", "", false, "");
        ...
        List res1 = await Service.restfulCall("/" + objid + "/proc/GetInfo",
            "POST", "{\"params\": [34,{\"sape\":4139,\"jack\":4098}]}");
        print("$res1");
      }
