...
#define VS_SUBVERSION   80   /* 3.5.0  high four bits are subversion, and lower four bits are release version */
...
/*---------get interfaces*/
    ...
    */
    ...
    virtual void *SRPAPI ImportRawContext(const VS_CHAR *ScriptInterface,const VS_CHAR *ContextName, VS_BOOL IsClass, const VS_CHAR *ContextInfo) = 0;

    virtual void *SRPAPI AssignRawObject( void *Object,void *RawObject ) = 0;
